...
def index():
    if request.method == 'POST':
                try:
                    ...
                    response = requests.get(f"https://www.google.com/search?q={query}&sca_esv=ec0f97d633954ec1&rlz=1C1VDKB_en-GBIN1108IN1108&udm=2&biw=1422&bih=650&ei=kO1MZu31N6rO1e8PzNKXwA0&ved=0ahUKEwjt_eGftZ-GAxUqZ_UHHUzpBdgQ4dUDCBA&oq=elon+musk&gs_lp=Egxnd3Mtd2l6LXNlcnAiCWVsb24gbXVza0gAUABYAHAAeACQAQCYAQCgAQCqAQC4AQzIAQCYAgCgAgCYAwCSBwCgBwA&sclient=gws-wiz-serp")
                    ...
                    client = pymongo.MongoClient("mongodb+srv://Rajeshwar+Busa:COVIDVIRUS@cluster0.rahwink.mongodb.net/xyzdb?retryWrites=true&w=majority", tlsCAFile=ca)
